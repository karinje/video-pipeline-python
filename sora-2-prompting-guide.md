...
**Robin Koenig** (Verified)  
**Joanne Shin** (Verified)  
Robin Koenig (OpenAI), Joanne Shin (OpenAI)

## Table of Contents
- [Crafting a successful video prompt](#crafting-a-successful-video-prompt)
- [Before you prompt](#before-you-prompt)
- [API Parameters](#api-parameters)
- [Prompt anatomy that works](#prompt-anatomy-that-works)
- [Visual cues that steer the look](#visual-cues-that-steer-the-look)
- [Control motion and timing](#control-motion-and-timing)
- [Lighting and color consistency](#lighting-and-color-consistency)
- [Use image input for more control](#use-image-input-for-more-control)
- [Dialogue and Audio](#dialogue-and-audio)
- [Iterate with the remix functionality](#iterate-with-the-remix-functionality)
- [Prompt Templates and Examples](#prompt-templates-and-examples)
...
- Original Video → Remix: "Change the color of the monster to orange"
- Original Video → Remix: "A second monster comes out right after"
